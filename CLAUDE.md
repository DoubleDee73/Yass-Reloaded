...
The version is managed in `resources/version.properties` and filtered into the build via Maven resource filtering. Current release branch convention: `YYYY.N_release` (e.g., `2026.5_release`).
