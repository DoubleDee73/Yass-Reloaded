...
public class YassOptions extends JDialog {
    ...
    private static class OwnerFrame extends JFrame {
        ...
        OwnerFrame() {
            URL icon16 = this.getClass().getResource("/img/yass-icon-16.png");
            URL icon32 = this.getClass().getResource("/img/yass-icon-32.png");
            URL icon48 = this.getClass().getResource("/img/yass-icon-48.png");
