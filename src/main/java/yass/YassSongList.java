...
public class YassSongList extends JTable {
    ...
    public YassSongList(YassActions a) {
        ...
        try {
            noCover = new ImageIcon(getClass().getResource("/img/NoCover.jpg"));
            brokenSong = new ImageIcon(getClass().getResource("/img/Broken.jpg"));
            openedIcon = new ImageIcon(getClass().getResource("/img/GrayOpen16.gif")).getImage();
            videoIcon = new ImageIcon(getClass().getResource("/img/Video.gif")).getImage();
            nobackgroundIcon = new ImageIcon(getClass().getResource("/img/NoBackground.gif")).getImage();
            perfectIcon = new ImageIcon(getClass().getResource("/img/Perfect.gif")).getImage();
            lockedIcon = new ImageIcon(getClass().getResource("/img/Locked.gif")).getImage();

            for (int i = 0; i < langIcons.length; i++) {
                // System.out.println("language: " + langID[i]);
                langIcons[i] = new ImageIcon(getClass().getResource("/img/"+langID[i].toLowerCase() + ".gif")).getImage();
            }
            err_minorpage_icon = new ImageIcon(getClass().getResource("/img/MinorPageError.gif")).getImage();
            err_major_icon = new ImageIcon(getClass().getResource("/img/MajorError2.gif")).getImage();
            err_file_icon = new ImageIcon(getClass().getResource("/img/FileError.gif")).getImage();
            err_tags_icon = new ImageIcon(getClass().getResource("/img/TagError.gif")).getImage();
            err_text_icon = new ImageIcon(getClass().getResource("/img/TextError.gif")).getImage();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
