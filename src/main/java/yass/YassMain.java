...
public class YassMain extends JFrame {
    ...
    private void initFrame() {
        ...
        URL icon16 = YassMain.this.getClass().getResource("/img/yass-icon-16.png");
        URL icon32 = YassMain.this.getClass().getResource("/img/yass-icon-32.png");
        URL icon48 = YassMain.this.getClass().getResource("/img/yass-icon-48.png");
