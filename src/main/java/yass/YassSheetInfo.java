...
public class YassSheetInfo extends JPanel {
    ...
    public YassSheetInfo(YassSheet s, int track) {
        ...
        try {
            err_page_icon = new ImageIcon(getClass().getResource("/img/MinorPageError.gif")).getImage();
            err_major_ico = new ImageIcon(getClass().getResource("/img/MajorError2.gif")).getImage();
            ...
            no_err_page_icon = new ImageIcon(getClass().getResource("/img/MinorPageNoError.gif")).getImage();
            no_err_major_ico = new ImageIcon(getClass().getResource("/img/MajorNoError2.gif")).getImage();
            no_err_file_icon = new ImageIcon(getClass().getResource("/img/FileNoError.gif")).getImage();
            no_err_tags_icon = new ImageIcon(getClass().getResource("/img/TagNoError.gif")).getImage();
            no_err_text_icon = new ImageIcon(getClass().getResource("/img/TextNoError.gif")).getImage();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
