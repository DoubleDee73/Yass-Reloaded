...
public class YassActions implements DropTargetListener {
    ...
    private final Action showAbout = new AbstractAction(I18.get("lib_about")) {
        public void actionPerformed(ActionEvent e) {
            URL url = getClass().getResource("/img/about.jpg");
    ...
    private final Action showHelp = new AbstractAction(I18.get("lib_help_offline")) {
        public void actionPerformed(ActionEvent e) {
            ...
            fh.pack();
            fh.setSize(500, 600);
            fh.setIconImage(new ImageIcon(YassActions.this.getClass().getResource("/img/yass-icon-16.png")).getImage());
            fh.setVisible(true);
        }
    };
    ...
    public void init(YassProperties p) {
        ...
        icons.put("new16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/New16.gif")));
        icons.put("new24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/New24.gif")));
        icons.put("open16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Open16.gif")));
        icons.put("open24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Open24.gif")));
        icons.put("save16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Save16.gif")));
        icons.put("save24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Save24.gif")));
        icons.put("saveas16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/SaveAs16.gif")));
        icons.put("saveas24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/SaveAs24.gif")));
        icons.put("list16Icon", new ImageIcon(getClass().getResource("/img/List16.gif")));
        icons.put("list24Icon", new ImageIcon(getClass().getResource("/img/List24.gif")));
        icons.put("playlist16Icon", new ImageIcon(getClass().getResource("/img/Playlist16.gif")));
        icons.put("playlist24Icon", new ImageIcon(getClass().getResource("/img/Playlist24.gif")));
        icons.put("add16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Add16.gif")));
        icons.put("add24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Add24.gif")));
        icons.put("import16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Import16.gif")));
        icons.put("import24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Import24.gif")));
        icons.put("edit16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Edit16.gif")));
        icons.put("edit24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Edit24.gif")));
        icons.put("editany24Icon", new ImageIcon(getClass().getResource("/img/EditAny24.gif")));
        // icons.put("hyphen16Icon", new ImageIcon(getClass().getResource("/yass/Hyphenate16.gif")));
        icons.put("hyphenate24Icon", new ImageIcon(getClass().getResource("/img/Hyphenate24.gif")));
        // icons.put("check16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Properties16.gif")));
        // icons.put("check24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Properties24.gif")));
        icons.put("spell24Icon", new ImageIcon(getClass().getResource("/img/SpellCheck24.gif")));
        icons.put("refresh16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Refresh16.gif")));
        icons.put("refresh24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Refresh24.gif")));
        icons.put("find16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Find16.gif")));
        icons.put("find24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Find24.gif")));
        icons.put("clearfind24Icon", new ImageIcon(getClass().getResource("/img/ClearFind24.gif")));
        icons.put("pagebreak16Icon", new ImageIcon(getClass().getResource("/img/PageBreak16.gif")));
        icons.put("pagebreak24Icon", new ImageIcon(getClass().getResource("/img/PageBreak24.gif")));
        icons.put("insertnote16Icon", new ImageIcon(getClass().getResource("/img/InsertNote16.gif")));
        icons.put("insertnote24Icon", new ImageIcon(getClass().getResource("/img/InsertNote24.gif")));
        insertNote.putValue(AbstractAction.SMALL_ICON, getIcon("insertnote16Icon"));
        icons.put("correctpagebreak24Icon", new ImageIcon(getClass().getResource("/img/CorrectPageBreak24.gif")));
        icons.put("correctfilenames24Icon", new ImageIcon(getClass().getResource("/img/CorrectFileNames24.gif")));
        icons.put("correcttags24Icon", new ImageIcon(getClass().getResource("/img/CorrectTags24.gif")));
        icons.put("correcttext24Icon", new ImageIcon(getClass().getResource("/img/CorrectText24.gif")));
        icons.put("correcttransposed24Icon", new ImageIcon(getClass().getResource("/img/CorrectTransposed24.gif")));
        icons.put("correctlength24Icon", new ImageIcon(getClass().getResource("/img/CorrectLength24.gif")));
        icons.put("correctalbum24Icon", new ImageIcon(getClass().getResource("/img/CorrectAlbum24.gif")));
        icons.put("correctyear24Icon", new ImageIcon(getClass().getResource("/img/CorrectYear24.gif")));
        icons.put("print16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Print16.gif")));
        icons.put("print24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Print24.gif")));
        icons.put("movie16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Movie16.gif")));
        icons.put("movie24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Movie24.gif")));
        icons.put("fastforward16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/FastForward16.gif")));
        icons.put("fastforward24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/FastForward24.gif")));
        icons.put("rewind16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Rewind16.gif")));
        icons.put("rewind24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Rewind24.gif")));
        icons.put("empty16Icon", new ImageIcon(getClass().getResource("/img/Empty16.gif")));
        icons.put("empty24Icon", new ImageIcon(getClass().getResource("/img/Empty24.gif")));
        icons.put("tiles24Icon", new ImageIcon(getClass().getResource("/img/Tiles24.gif")));
        icons.put("notiles16Icon", new ImageIcon(getClass().getResource("/img/NoTiles16.gif")));
        icons.put("notiles24Icon", new ImageIcon(getClass().getResource("/img/NoTiles24.gif")));
        icons.put("lyrics16Icon", new ImageIcon(getClass().getResource("/img/Lyrics16.gif")));
        icons.put("lyrics24Icon", new ImageIcon(getClass().getResource("/img/Lyrics24.gif")));
        icons.put("noerr24Icon", new ImageIcon(getClass().getResource("/img/NoError24.gif")));
        icons.put("err24Icon", new ImageIcon(getClass().getResource("/img/Error24.gif")));
        icons.put("grayOpen16Icon", new ImageIcon(getClass().getResource("/img/GrayOpen16.gif")));
        icons.put("grayOpen24Icon", new ImageIcon(getClass().getResource("/img/GrayOpen24.gif")));
        icons.put("just16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/text/AlignJustify16.gif")));
        icons.put("just24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/text/AlignJustify24.gif")));
        icons.put("freestyle16Icon", new ImageIcon(getClass().getResource("/img/Freestyle16.gif")));
        icons.put("freestyle24Icon", new ImageIcon(getClass().getResource("/img/Freestyle24.gif")));
        icons.put("golden16Icon", new ImageIcon(getClass().getResource("/img/Golden16.gif")));
        icons.put("golden24Icon", new ImageIcon(getClass().getResource("/img/Golden24.gif")));
        icons.put("rap16Icon", new ImageIcon(getClass().getResource("/img/Rap16.gif")));
        icons.put("rap24Icon", new ImageIcon(getClass().getResource("/img/Rap24.gif")));
        icons.put("rapgolden16Icon", new ImageIcon(getClass().getResource("/img/RapGolden16.gif")));
        icons.put("rapgolden24Icon", new ImageIcon(getClass().getResource("/img/RapGolden24.gif")));
        icons.put("space16Icon", new ImageIcon(getClass().getResource("/img/Space16.gif")));
        icons.put("space24Icon", new ImageIcon(getClass().getResource("/img/Space24.gif")));
        icons.put("minus16Icon", new ImageIcon(getClass().getResource("/img/Minus16.gif")));
        icons.put("minus24Icon", new ImageIcon(getClass().getResource("/img/Minus24.gif")));
        icons.put("lockon24Icon", new ImageIcon(getClass().getResource("/img/Lock24.gif")));
        icons.put("lockoff24Icon", new ImageIcon(getClass().getResource("/img/Unlock24.gif")));
        ...
        icons.put("home16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Home16.gif")));
        icons.put("home24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Home24.gif")));
        icons.put("err24Icon", new ImageIcon(getClass().getResource("/img/Error24.gif")));
        icons.put("setTitle24Icon", new ImageIcon(getClass().getResource("/img/SetTitle24.gif")));
        icons.put("setArtist24Icon", new ImageIcon(getClass().getResource("/img/SetArtist24.gif")));
        icons.put("setGenre24Icon", new ImageIcon(getClass().getResource("/img/SetGenre24.gif")));
        icons.put("setEdition24Icon", new ImageIcon(getClass().getResource("/img/SetEdition24.gif")));
        icons.put("setLanguage24Icon", new ImageIcon(getClass().getResource("/img/SetLanguage24.gif")));
        icons.put("setYear24Icon", new ImageIcon(getClass().getResource("/img/SetYear24.gif")));
        icons.put("newEdition24Icon", new ImageIcon(getClass().getResource("/img/NewEdition24.gif")));
        icons.put("newFolder24Icon", new ImageIcon(getClass().getResource("/img/NewFolder24.gif")));
        icons.put("renameFolder24Icon", new ImageIcon(getClass().getResource("/img/RenameFolder24.gif")));
        icons.put("play16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Play16.gif")));
        icons.put("play24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Play24.gif")));
        icons.put("stop16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Stop16.gif")));
        icons.put("stop24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/media/Stop24.gif")));
        ...
        icons.put("stepf16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Down16.gif")));
        icons.put("stepf24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Down24.gif")));
        icons.put("stepb16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Up16.gif")));
        icons.put("stepb24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Up24.gif")));
        ...
        icons.put("zoomstd16Icon", new ImageIcon(getClass().getResource("/img/ZoomPage16.gif")));
        icons.put("zoomstd24Icon", new ImageIcon(getClass().getResource("/img/ZoomPage24.gif")));
        icons.put("zoomin16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/ZoomIn16.gif")));
        icons.put("zoomin24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/ZoomIn24.gif")));
        icons.put("zoomout16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/ZoomOut16.gif")));
        icons.put("zoomout24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/ZoomOut24.gif")));
        icons.put("zoomall16Icon", new ImageIcon(getClass().getResource("/img/ZoomAll16.gif")));
        icons.put("zoomall24Icon", new ImageIcon(getClass().getResource("/img/ZoomAll24.gif")));
        ...
        icons.put("stepl16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Back16.gif")));
        icons.put("stepl24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Back24.gif")));
        icons.put("stepr16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Forward16.gif")));
        icons.put("stepr24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/navigation/Forward24.gif")));
        ...
        icons.put("setdir24Icon", new ImageIcon(getClass().getResource("/img/SetDir24.gif")));
        icons.put("setdir24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Preferences24.gif")));
        icons.put("copy16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Copy16.gif")));
        icons.put("copy24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Copy24.gif")));
        icons.put("pasteMelody16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Paste16.gif")));
        icons.put("pasteMelody24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Paste24.gif")));
        icons.put("paste16Icon", new ImageIcon(getClass().getResource("/img/PasteNew16.gif")));
        icons.put("paste24Icon", new ImageIcon(getClass().getResource("/img/PasteNew24.gif")));
        icons.put("insertb16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/table/RowInsertBefore16.gif")));
        icons.put("insertb24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/table/RowInsertBefore24.gif")));
        icons.put("inserta16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/table/RowInsertAfter16.gif")));
        icons.put("inserta24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/table/RowInsertAfter24.gif")));
        icons.put("split16Icon", new ImageIcon(getClass().getResource("/img/Split16.gif")));
        icons.put("split24Icon", new ImageIcon(getClass().getResource("/img/Split24.gif")));
        icons.put("join16Icon", new ImageIcon(getClass().getResource("/img/Join16.gif")));
        icons.put("join24Icon", new ImageIcon(getClass().getResource("/img/Join24.gif")));
        icons.put("delete16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Delete16.gif")));
        icons.put("delete24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Delete24.gif")));
        icons.put("removeSyllable16Icon", new ImageIcon(getClass().getResource("/img/RemoveSyllable16.gif")));
        icons.put("removeSyllable24Icon", new ImageIcon(getClass().getResource("/img/RemoveSyllable24.gif")));
        icons.put("bookmarks24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Bookmarks24.gif")));
        ...
        icons.put("undo16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Undo16.gif")));
        icons.put("undo24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Undo24.gif")));
        icons.put("redo16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Redo16.gif")));
        icons.put("redo24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Redo24.gif")));
        icons.put("snapshot24Icon", new ImageIcon(getClass().getResource("/img/Snapshot24.gif")));
        icons.put("snapshot16Icon", new ImageIcon(getClass().getResource("/img/Snapshot16.gif")));
        icons.put("gap16Icon", new ImageIcon(getClass().getResource("/img/Gap16.gif")));
        icons.put("gap24Icon", new ImageIcon(getClass().getResource("/img/Gap24.gif")));
        icons.put("help16Icon", new ImageIcon(getClass().getResource("/img/Help16.gif")));
        icons.put("help24Icon", new ImageIcon(getClass().getResource("/img/Help24.gif")));
        ...
        icons.put("auto16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/development/Application16.gif")));
        icons.put("auto24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/development/Application24.gif")));
        icons.put("pref16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Preferences16.gif")));
        icons.put("pref24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Preferences24.gif")));
        showOptions.putValue(AbstractAction.SMALL_ICON, getIcon("pref16Icon"));
        icons.put("playvis16Icon", new ImageIcon(getClass().getResource("/img/PlayVisible16.gif")));
        icons.put("playvis24Icon", new ImageIcon(getClass().getResource("/img/PlayVisible24.gif")));
        icons.put("playfrozen16Icon", new ImageIcon(getClass().getResource("/img/PlayFrozen16.gif")));
        icons.put("playfrozen24Icon", new ImageIcon(getClass().getResource("/img/PlayFrozen24.gif")));
        icons.put("playpage16Icon", new ImageIcon(getClass().getResource("/img/PlayPage16.gif")));
        playPage.putValue(AbstractAction.SMALL_ICON, getIcon("playpage16Icon"));
        icons.put("playbefore16Icon", new ImageIcon(getClass().getResource("/img/PlayBefore16.gif")));
        playBefore.putValue(AbstractAction.SMALL_ICON, getIcon("playbefore16Icon"));
        icons.put("playnext16Icon", new ImageIcon(getClass().getResource("/img/PlayNext16.gif")));
        playNext.putValue(AbstractAction.SMALL_ICON, getIcon("playnext16Icon"));
        icons.put("record16Icon", new ImageIcon(getClass().getResource("/img/Record16.gif")));
        icons.put("record24Icon", new ImageIcon(getClass().getResource("/img/Record24.gif")));
        recordSelection.putValue(AbstractAction.SMALL_ICON, getIcon("record16Icon"));
        icons.put("correct24Icon", new ImageIcon(getClass().getResource("/img/Correct24.gif")));
        icons.put("correct16Icon", new ImageIcon(getClass().getResource("/img/Correct16.gif")));
        showErrors.putValue(AbstractAction.SMALL_ICON, getIcon("correct16Icon"));
        icons.put("nextBreak24Icon", new ImageIcon(getClass().getResource("/img/NextBreak24.gif")));
        icons.put("prevBreak24Icon", new ImageIcon(getClass().getResource("/img/PrevBreak24.gif")));
        icons.put("rollLeft24Icon", new ImageIcon(getClass().getResource("/img/RollLeft24.gif")));
        icons.put("rollRight24Icon", new ImageIcon(getClass().getResource("/img/RollRight24.gif")));
        icons.put("rollLeft16Icon", new ImageIcon(getClass().getResource("/img/RollLeft16.gif")));
        icons.put("rollRight16Icon", new ImageIcon(getClass().getResource("/img/RollRight16.gif")));
        ...
        icons.put("noalign24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/AlignBottom24.gif")));
        icons.put("align24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/AlignCenter24.gif")));
        icons.put("alignleft16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/text/AlignLeft16.gif")));
        icons.put("alignleft24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/text/AlignLeft24.gif")));
        icons.put("midi24Icon", new ImageIcon(getClass().getResource("/img/Midi24.gif")));
        icons.put("nomidi24Icon", new ImageIcon(getClass().getResource("/img/NoMidi24.gif")));
        icons.put("mute24Icon", new ImageIcon(getClass().getResource("/img/Mute24.gif")));
        icons.put("nomute24Icon", new ImageIcon(getClass().getResource("/img/NoMute24.gif")));
        icons.put("speedone24Icon", new ImageIcon(getClass().getResource("/img/SpeedOne24.gif")));
        icons.put("speedtwo24Icon", new ImageIcon(getClass().getResource("/img/SpeedTwo24.gif")));
        icons.put("speedthree24Icon", new ImageIcon(getClass().getResource("/img/SpeedThree24.gif")));
        icons.put("speedfour24Icon", new ImageIcon(getClass().getResource("/img/SpeedFour24.gif")));
        icons.put("info16Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Information16.gif")));
        icons.put("info24Icon", new ImageIcon(getClass().getResource("/toolbarButtonGraphics/general/Information24.gif")));
    ...
    */
    ...
    private class OwnerFrame extends JFrame {
        OwnerFrame() {
            setIconImage(new ImageIcon(YassActions.this.getClass().getResource("/img/yass-icon-16.png")).getImage());
        }
